...
- [LoRaWAN Node - Adafruit 32u4 LoRa](#lorawan-node---adafruit-32u4-lora)
  - [Hardware](#hardware)
    - [Microcontroller](#microcontroller)
    - [Sensor](#sensor)
  - [Software](#software)
  - [Services](#services)
    - [Registration of the sensor node with The Things Network (TTN)](#registration-of-the-sensor-node-with-the-things-network-ttn)
    - [TTN Payload Decoding](#ttn-payload-decoding)
